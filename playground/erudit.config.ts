export default defineEruditConfig({
  ...
  lastmod: {
    enabled: true,
    type: 'custom',
    scriptPath: './lastmodProvider',
  },
  countElements: ['heading', ['problem', 'problems']],
  asideMajor: {
    siteInfo: {
      title: 'Мажор Имя',
      logotype: 'https://ru.omath.net/public/open-math-shared/logotype.svg',
      short: 'Фубар А я?',
    },
    customLinks: [
      {
  ...
  favicon: {
    default: './public/ada.png',
    book: 'https://ir.ozone.ru/s3/cms/d2/t26/wc400/logo_ozon_1.png',
  },
  analytics: {
    google: {
  ...
  problemChecks: ['./checks/strLen'],
  autoImports: ['./my-globals'],
  // style: {
  //   brandColor: '#7e73c9',
  // },
  seo: {
    ogImage: {
      ...
      phrases: { learn: 'Изучить', open: 'Открыть' },
      logotype: './public/ada.png',
    },
  },
  loadingSvg: `
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="margin: auto; background: none; display: block; shape-rendering: auto;"  viewBox="10 10 80 80" preserveAspectRatio="xMidYMid">
