    ...
    >
        <div class="relative">
            ...
            <div
                ...
                :title="phrase.editor"
                class="bg-bg-main micro:size-[28px] absolute bottom-0 left-1/2
                    grid size-[24px] -translate-x-1/2 translate-y-1/2
                    cursor-help place-items-center rounded-full border-2
                    border-(--colorBorder)"
            >
                <MyIcon
                    name="graduation"
                    class="size-[82%] text-(--colorIcon)"
                />
            </div>
        </div>
        <div class="flex flex-col gap-(--_pMainY) text-center">
            ...
            <div
                ...
                class="micro:text-[1.3em] text-text-muted relative -top-1
            ...
            >
                <a
                    ...
                    class="text-main-sm hocus:bg-(--colorBg) rounded border-2
                        border-(--colorBorder) bg-transparent px-2 py-1
