        ...
        >
            <div
                ...
                class="border-border/60 bg-bg-main text-main-xs text-text-muted
                    flex h-(--labelHeight) cursor-help items-center gap-[4px]
                    rounded-xl border px-[8px] shadow
                    shadow-[light-dark(#d9d9d9,#3c3c3c)]
                    transition-[background,border,color,box-shadow]"
            >
                <Icon :name="attributeIcons[attribute]" class="text-[15px]" />
            ...
            <div
                ...
                class="text-main-xs flex h-(--labelHeight) cursor-help
                    items-center gap-[4px] rounded-xl border
                    border-(--levelColor)/30 bg-(--levelColor)/10 px-[8px]
